...
- **[@aha/api](./packages/api/docs/README.md)**: API client wrapper for AhaSlides endpoints (counting and answer submission APIs).
...
│   ├── api/            # API client for AhaSlides endpoints
